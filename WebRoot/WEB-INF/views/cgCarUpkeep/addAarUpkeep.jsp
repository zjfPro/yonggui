...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "post",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/carUpkeep/add/gotoAddCgCarUpkeep",
			  success: function(data){
			 	if(data == "1"){
			 	alert("添加成功")
			 		/* var queren = confirm("添加成功,是否返回车辆保养列表?");
			 		if(queren){
			 			cleanPage();
			 		} */
				...
				<form name="form" id="form" method="post">
					<table class="nav_tab">
						...
						<tr class="line_g">
							...
							<td><input type="text" class="nt-text" name="upkeepPeople" id="upkeepPeople"/></td>
							<th width="10%">车辆：</th>
							<td>
						...
						<tr class="line_g">
							...
							<td><input type="text" class="nt-text" name="mileage" id="mileage"/></td>
						</tr>
						<tr class="line_g">
							<th width="10%">保养项目：</th>
							<td><input type="text" class="nt-text" name="upkeepProject" id="upkeepProject"/></td>
							<th width="10%">更换发动机机油型号：</th>
							<td><input type="text" class="nt-text" name="uodateEngineOilType" id="uodateEngineOilType"/></td>
						</tr>
						<tr class="line_g">
							<th width="10%">上次保养里程表读数：</th>
							<td><input type="text" class="nt-text" name="lastMileage" id="lastMileage"/></td>
