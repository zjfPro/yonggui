...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/help/update/updateHelp",
					...
					<table class="nav_tab">
						<tbody>
							<tr>
								<th>类型：</th>
								<td>
								 <select name="helpType" class="nt-select">
					                  <option ${helps.id == 1 ? "selected" : "" } value="1">租车指南</option>
                					  <option ${helps.id == 2 ? "selected" : "" } value="2">租车流程</option>
                					  <option ${helps.id == 3 ? "selected" : "" } value="3">企业租凭</option>
                					  <option ${helps.id == 4 ? "selected" : "" } value="4">长期租车</option>
                					  <option ${helps.id == 5 ? "selected" : "" } value="5">短期租车</option>
					              </select>
					             </td>
							</tr>
							<tr>
