  ...
  <div class="box w1200 clearfix">
	<div class="sidebar-box">
      <div class="sidebar">
        <h2>新闻资讯</h2>
        <ul>
          <li class="on"><a href="<%=basePath%>control/news/pc/newsInformationList?type=0">公司新闻</a></li>
          <li><a href="<%=basePath%>control/news/pc/newsInformationList?type=1">行业资讯</a></li>
        </ul>
      </div>
    </div>
    <!--sidebarbox end-->
