...
<script type="text/javascript">
	...
	function pageTurning(pageNo,totalPages,bOrn){
		if(pageNo==1&&bOrn=='back'){
    		...
    		window.location.href="<%=basePath%>pc/investorPc/carUpkeep?page="+pageNo+"&click="+bOrn;
		};
    ...
    <div class="nav-box">
      <ul>
        <c:if test="${!empty sessionScope.investor  }">
      		...
      		<li  class="curr"><a href="<%=basePath%>pc/investorPc/goto/personCenter">个人中心</a></li>
      	</c:if>
      	<c:if test="${ empty sessionScope.investor  }">
      		<li><a href="<%=basePath%>pc/investorPc/goto/investorLogin">登录</a></li>
      	</c:if>
...
<div class="user-box">
  <div class="u-head w1200">
    <a href="#">首页</a><span>></span><span>车辆保养</span>
  </div>
  <div class="user-wrap w1200 clearfix">
    <div class="user-sidebar-box">
      <div class="user-sidebar clearfix">
        <ul>
          <li><a href="<%=basePath%>pc/investorPc/goto/personCenter">订单管理</a></li>
          ...
          <li class="on"><a href="<%=basePath%>pc/investorPc/carUpkeep">车辆保养</a></li>
        ...
        <table class="ord-tab">
          ...
          <tfoot>
            <tr>
              <td colspan="6">
                <div class="page-box">
                  <%-- <a href="<%=basePath%>pc/investorPc/carUpkeep?page=${requestScope.pageUtil.page }&click=back">上一页</a>
                  	${requestScope.pageUtil.page}/${requestScope.pageUtil.totalPages}
                  <a href="<%=basePath%>pc/investorPc/carUpkeep?page=${requestScope.pageUtil.page }&click=next">下一页</a> --%>
