...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/setting/add/addSetting",
			...
			<div class="infolist">
				<form name="form" id="form" method="post">
					...
					<tr class="line_g">
						...
						<tr class="line_g">
							<td width="40%" align="right">最小车辆库存：</td>
							<td><input type="text" class="nt-text" name="carStockMinAlert" id="carStockMinAlert"/></td>
						</tr>
						<tr class="line_g">
							<td width="40%" align="right">最大车辆库存：</td>
							<td><input type="text" class="nt-text" name="carStockMaxAlert" id="carStockMaxAlert"/></td>
						</tr>
					</table>
				</form>
				<div class="nt-btmbox">
