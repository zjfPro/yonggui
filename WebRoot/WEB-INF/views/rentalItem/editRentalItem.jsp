					...
					<thead>
			          <tr>
						...
						<tbody>
							...
							<tr>
								<th>车辆：</th>
								<td><input id="hiddenCarInfoId" name="hiddenCarInfoId" value="${ccri.carInfoId}"  type="hidden"/>
								<select name="carInfoId" id="carInfoId" style="width: 120px;" onchange="getOptionData(this.value);" ></select>
								</td>
								
								<th>操作人(员工)：</th>
								<td><input id="hiddenstaffId" name="hiddenstaffId" value="${ccri.staffId}"  type="hidden"/>
							...
							<tr>
								<th>价格：</th>
								<td>
									<input type="text" class="nt-text" name="unitPrice" id="unitPrice" value="${ccri.unitPrice}"/>
								</td>
								<th style="width: 200px;">销售单位 (例:小时/日)：</th>
								<td>
									<input type="text" class="nt-text" name="unitName" id="unitName" value="${ccri.unitName}"/>
								</td>
								<th style="width: 200px;">销售单位数量：</th>
								<td colspan="8">
									<input type="text" class="nt-text" name="unitNumber" id="unitNumber" value="${ccri.unitNumber}"/>
								</td>
							</tr>
							<tr>
								<th>是否上架</th>
								...
								<td>
									<input type="text" class="nt-text" name="earnestMoney" id="earnestMoney" value="${ccri.earnestMoney}"/>
								</td>
								<th style="width: 200px;">押金：</th>
								<td colspan="8">
									<input type="text" class="nt-text" name="foregiftMoney" id="foregiftMoney" value="${ccri.foregiftMoney}"/>
								</td>
							</tr>
							<tr>
								<th>标题：</th>
								<td colspan="8">
									<input type="text" class="nt-text" name="title" id="title"  style="width: 600px;" value="${ccri.title}"/>
								</td>
							</tr>
							<tr>
								<th>内容描述：</th>
								<td colspan="8"><div class="table_area">
										<textarea id="editor" name="content"
											style="width:100%;height:150px;">${ccri.content}</textarea>
									</div>
								</td>
							</tr>
						</tbody>
