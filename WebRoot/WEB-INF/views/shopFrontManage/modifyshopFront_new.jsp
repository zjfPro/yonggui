			...
			//document.getElementById("form").submit();
				$.ajaxFileUpload({
             	...
             	fileElementId: 'logo', //文件上传域的ID
          		url: "<%=basePath%>shopFront/update/modifyshopFront", //用于文件上传的服务器端请求地址
                secureuri: false, //是否需要安全协议，一般设置为false
					...
					<table class="nav_tab">
						...
						<tbody>
							...
							<td><input type="text" class="text width300" name="name"
								id="name" value="${requestScope.data.name}" /></td>
						</tr>
						</tbody>
						<tfoot></tfoot>
					</table>
					<table class="nav_tab">
						...
						<tr>
							...
							<td><input type="text" class="text width300" name="address"
								id="address" value="${requestScope.data.address}" /></td>
						</tr>
						<tr>
							<th>地址经度：</th>
							<td><input type="text" class="text width300"
								name="longitude" id="longitude"
								value="${requestScope.data.longitude}" /></td>
						</tr>
						<tr>
							<th>地址纬度：</th>
							<td><input type="text" class="text width300" name="latitude"
								id="latitude" value="${requestScope.data.latitude}" /></td>
						</tr>
						<tr>
							<th>门店介绍：</th>
							<td><textarea id="editor" name="introduce" style="width:100%;height:150px;"></textarea></td>
						</tr>
						...
						<c:if test="${sessionScope.admin!=null }">
							<tr>
								...
								<td><input type="text" class="text width300"
									...
									value="${requestScope.data.manageStaff.id}" /></td>
							</tr>
						</c:if>
 						</tbody>
					</table>
