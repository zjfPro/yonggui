			...
			$("#addBtn").click(function() {
				if (!validate.form()) {
					...
					$.ajaxFileUpload({
						...
						url: "<%=basePath%>control/activity/update/updateCompanyActivity",
						secureuri: false, //是否需要安全协议，一般设置为false
...
<body>
	...
	<div class="content">
		<div class="content_box">
			...
			<div class="infolist">
				<form name="form" id="form" method="post" action="<%=basePath%>control/activity/update/updateCompanyActivity" enctype="multipart/form-data">
					<table class="left_table">
						<tr class="line_g">
							<td width="10%">活动首页图片：</td>
							<td>
