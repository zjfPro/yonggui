...
<script type="text/javascript">
	...
	function checkForm(){
		...
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/authority/add/gotoAddCcgStaffManageModel",
			  success: function(data){
			 	if(data == "1"){
			 		var queren = confirm("添加成功,是否返回模块列表?");
			 		if(queren){
			 			cleanPage();
			 		}else{
			 			cleanAll();
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a href="#">个人桌面</a><span> > </span> <a href="#">基础信息</a><span>></span>增加模块
			</div>
			<div class="infolist">
				<form name="form" id="form" method="post">
					<table class="left_table">
						...
						<tr class="line_g">
							<td width="10%">模块名称：</td>
							<td><input type="text" class="text width300" name="text" id="text"/><a onclick="cleaninput('text')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td>模块级别：</td>
						...
						<tr class="line_g">
							...
							<td><input type="text" class="text width300" name="url" id="url"/><a onclick="cleaninput('url')">清空</a></td>
						</tr>
