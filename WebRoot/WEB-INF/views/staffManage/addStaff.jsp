...
//上传  end--------------------------------------------------------------------------------------------------------------	
	...
	function checkForm(){
        ...
        (
            {
                url: "<%=basePath%>control/staffManager/add/addStaff?"+formval, //用于文件上传的服务器端请求地址
                ...
                {
                	if(data == "1"){
    			 		var queren = confirm("添加成功,是否返回员工列表?");
    			 		if(queren){
    			 			window.location.href="<%=basePath%>control/staffManager/select/staffList";
    			 		}
    				}else{
	...
	function selectShopFront(id){
		...
		$.ajax({
			...
			$.ajax({
				type:'post',
				url:'<%=basePath%>ajax/select/getShopFrontRoleContainer',
				data: "id="+id,
				dataType : 'json',
				success : function(data) {
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a><span> > </span> <a href="<%=basePath%>control/staffManager/select/staffList">员工管理</a><span>></span>添加员工
			</div>
			<div class="infolist">
				<form name="form" id="form" method="post" enctype="multipart/form-data">
					<table class="left_table">
						...
						<tr class="line_g">
							<td width="10%">姓名：</td>
							<td><input type="text" class="text width300" name="name" id="name"/><a onclick="cleaninput('name')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">身份证：</td>
							<td><input type="text" class="text width300" name="idcard" id="idcard"/><a onclick="cleaninput('idcard')">清空</a></td>
						</tr>
						
						<tr class="line_g">
							<td width="10%">编号：</td>
							<td><input type="text" class="text width300" name="number" id="number"/><a onclick="cleaninput('number')">清空</a></td>
						</tr>

						<tr class="line_g">
							<td width="10%">所属门店：</td>
							<td>
							<!-- <input type="text" class="text width300" name="shopFrontId" id="shopFrontId"/><a onclick="cleaninput('shopFrontId')">清空
							</a> -->
							<select name="shopFrontId" id="shopFrontId" style="width: 200px;" onchange="selectShopFront(this.value)" ></select>
							</td>
						</tr>
						...
						<tr class="line_g">
							<td width="10%">职位：</td>
							<td>
								<!-- <input type="text" class="text width300" name="staffPositionId" id="staffPositionId"/>
								<a onclick="cleaninput('staffPositionId')">清空</a> -->
						...
						<tr class="line_g">
							...
							<td>
								...
								<!-- <input type="text" class="text width300" name="decpId" id="decpId"/><a onclick="cleaninput('decpId')">清空</a> -->
						...
						<tr class="line_g">
							<td width="10%">账号：</td>
							<td><input type="text" class="text width300" name="account" id="account"/><a onclick="cleaninput('account')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">密码：</td>
							<td><input type="password" class="text width300" name="password" id="password"/><a onclick="cleaninput('password')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">入职时间：</td>
						...
						<tr class="line_g">
							<td width="10%">联系电话：</td>
							<td><input type="text" class="text width300" name="phone" id="phone"/><a onclick="cleaninput('phone')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">备用电话：</td>
							<td><input type="text" class="text width300" name="sparePhone" id="sparePhone"/><a onclick="cleaninput('sparePhone')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">住址：</td>
							<td><input type="text" class="text width300" name="address" id="address"/><a onclick="cleaninput('address')">清空</a></td>
						</tr>
						<tr class="line_g">
							<td width="10%">离职时间：</td>
						...
						<tr class="line_g">
							...
							<td>
								...
								&nbsp;
								角色名<input name="roleName" id="roleName" /> <input name="models" id="models" type="hidden"/>
								<div>
						...
						<tr class="line_g">
							<td width="10%">备注：</td>
							<td><input type="text" class="text width300" name="remarks" id="remarks"/><a onclick="cleaninput('remarks')">清空</a></td>
						</tr>
