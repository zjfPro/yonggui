...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/accident/add/addAccident",
     ...
     <form name="form" id="form" method="post">
      <table class="nav_tab">
        ...
        <tbody>
          <tr>
            <th>事故时间：</th>
            <td><input type="text" id="trafficAccidentTimes" name="trafficAccidentTimes" class="Wdate nt-text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></td>
            <th>事故地点：</th>
            <td><input class="nt-text" type="text" id="trafficAccidentAddress" name="trafficAccidentAddress"></td>
            <th>事故情况：</th>
            <td><input class="nt-text" type="text" id="trafficAccidentInfo" name="trafficAccidentInfo"></td>
            <th>事故描述：</th>
          ...
          <tr>
            <th>责任认定：</th>
            <td colspan="7"><input class="nt-text-long" type="text" id="responsibility" name="responsibility"></td>
          </tr>
        </tbody>
        <tfoot></tfoot>
        </table>
        ...
        <tbody>
          <tr>
            <th>赔偿金额：</th>
            <td><input class="nt-text" type="text" id="compensateMoney" name="compensateMoney"></td>
            <th>个人负担比例：</th>
