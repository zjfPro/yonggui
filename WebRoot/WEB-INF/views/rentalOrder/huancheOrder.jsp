...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a><span> > </span> <a>基础信息</a><span>></span>还车
			</div>
			<div class="infolist">
				<form name="form" id="form" method="post">
				<input id="huancheorderID" name="huancheorderID" value="${wanshandd.id}"  type="hidden"/>
				<input id="chejiluID" name="chejiluID" value="${chejilu.id}"  type="hidden"/>
				<input id="mdID" name="mdID" value="${wanshandd.shopFrontId}"  type="hidden"/>
					<table class="left_table">
						...
						<tr class="line_g">
							<td width="10%">还车里程数：</td>
							<td>
								<input type="text" class="text width300" name="huaicheMileage" id="huaicheMileage" />
							</td>
						</tr>
						...
						<tr class="line_g">
							...
							<td>
								${chejilu.useUserPhone}
							</td>
						</tr>
						<tr class="line_g">
							<td width="10%">借车时里程数：</td>
							<td>
								${chejilu.currentMileage}
							</td>
						</tr>
