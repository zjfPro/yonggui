...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/rentalOrder/update/gotoPayment",
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a><span> > </span> <a>基础信息</a><span>></span>订单付款
			</div>
			<div class="infolist">
				<form name="form" id="form" method="post">
				<input id="fukuanorderID" name="fukuanorderID" value="${wanshandd.id}"  type="hidden"/>
					<table class="left_table">
						...
						<tr class="line_g">
							<td width="10%">定金：</td>
							<td>
								<input type="text" class="text width300" name="earnestMoney" id="earnestMoney" />
						...
						<tr class="line_g">
							<td width="10%">押金：</td>
							<td>
								<input type="text" class="text width300" name="foregiftMoney" id="foregiftMoney"/>
						...
						<tr class="line_g">
							<td width="10%">支付总价：</td>
							<td>
								<input type="text" class="text width300" name="buyMoney" id="buyMoney"/>
