...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/series/update/updateSerie",
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a><span> > </span> <a href="control/series/select/seriesList">系列信息</a><span>></span>修改系列
			</div>
			<div class="infolist">
				...
				<input type="hidden" id="ccId" name="ccId" value="${requestScope.brands.id }" />
					<table class="left_table">
						<tr>
							...
							<td><input type="text" class="nt-text" name="series" id="series" value="${requestScope.brands.series }"/><a onclick="cleaninput('series')">清空</a></td>
						</tr>
					</table>
				</form>
				<div class="nt-btmbox">
