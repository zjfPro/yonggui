...
<script type="text/javascript">
	 function deleteChecked() {
           ...
           if (window.confirm("确认删除所选中的数据？")) {
        		$.ajax({
    				url : "<%=basePath%>control/manufacturer/delete/deleteManufacturer",
         ...
         function checkDetail() {
            ...
            if(selcount!=0){
            	if(selcount==1){
            		var ccId = strs[0];
            	    window.location.href="control/manufacturer/goto/updateManufacturerPage?ccId="+ccId; 
...
function addChecked(){
	...
	content: 'url:<%=basePath%>control/manufacturer/goto/addManufacturer',	 //内文是页面，引入页面地址
...
function updateType(id){
 $.dialog({
	title: '修改车辆类型',
	content: 'url:<%=basePath%>control/manufacturer/goto/updateManufacturerPage?ccId='+id,	
	cancelVal: '关闭',				
	cancel: true, 
	width: '580px',
	height: '300px',
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a> > <span></span> <a href="control/manufacturer/select/manufacturerList">车辆厂商</a> > <span></span>厂商列表
			</div>
			<div class="infolist">
								...
								<td colspan="16">
									<div class="clear">
										...
										<div class="searchbox fright">
											<input class="sea_text" type="text" name="text" value="${requestScope.text}" placeholder="厂商"/><input
