...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/manufacturer/update/updateManufacturer",
...
<body>
	...
	<div class="content">
		<div class="content_box">
			<div class="current">
				<a>个人桌面</a><span> > </span> <a>厂商信息</a><span>></span>修改厂商
			</div>
			<div class="infolist">
				...
				<input type="hidden" id="ccId" name="ccId" value="${requestScope.brands.id }" />
					<table class="left_table">
						<tr>
							...
							<td><input type="text" class="nt-text" name="manufacturer" id="manufacturer" value="${requestScope.brands.manufacturer }"/><a onclick="cleaninput('manufacturer')">清空</a></td>
						</tr>
					</table>
				</form>
				<div class="nt-btmbox">
