...
<div class="login-box">
  <form id="loginForm">
    <ul>
      ...
      <%--<li style="padding-left:51px; color:#2a4a61;">
      <label><input type="checkbox" class="inp-che"><span>&ensp;记住密码</span></label>
      </li>
      --%>
      <li>(管理员专用)</li>
      <li style="padding-left:51px;"><input type="button" class="inp-btn col" id="loginBtn" value="登录">&ensp;&ensp;<input type="button" class="inp-btn" value="重置"></li>
    </ul>
  </form>
</div>
<script>
