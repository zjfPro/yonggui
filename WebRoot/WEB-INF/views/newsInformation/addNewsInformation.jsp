			...
			$("#addBtn").click(function() {
				if (!validate.form()) {
					...
					$.ajaxFileUpload({
						...
						url: "<%=basePath%>control/news/add/addNewsInformation",
						secureuri: false, //是否需要安全协议，一般设置为false
...
<body>
	...
	<div class="content">
		<div class="content_box">
			...
			<div class="infolist">
				<form name="form" id="form" method="post" action="<%=basePath%>control/news/add/addNewsInformation" enctype="multipart/form-data">
