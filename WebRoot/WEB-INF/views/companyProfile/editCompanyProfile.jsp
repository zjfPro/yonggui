				...
				<input type="hidden" id="jjid" name="jjid" value="${cpDetail.id}" />
					<table class="left_table">
						...
						<tr class="line_g">
							<td width="10%">标题：</td>
							<td>
								<input type="text" class="text width300" name="title" id="title" value="${cpDetail.title}"/>
							</td>
						</tr>
						...
						<tr class="line_g">
							<td width="10%">备注：</td>
							<td>
								<input type="text" class="text width300" name="remark" id="remark" value="${cpDetail.remark}"/>
							</td>
						</tr>
					</table>
					<div class="nt-btmbox">
