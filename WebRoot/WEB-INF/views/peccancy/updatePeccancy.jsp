...
<script type="text/javascript">
	...
	function checkForm(){
		$.ajax({
			  ...
			  type: "POST",
			  data: $("#form").serialize(),
			  url: "<%=basePath%>control/peccancy/update/updateUserRecord",
    ...
    <input type="hidden" name="id" value="${requestScope.data.id}" />
      <table class="nav_tab">
        <thead>
          ...
          <tr>
           ...
           <td>
            ...
            <th>借车人名字：</th>
            <%-- <td><input class="nt-text" type="text" id="carUseRecordsId" name="carUseRecordsId" value="${requestScope.data.records.useUserName }"
            	onchange="accountDriverId(this.value)" placeholder="输入借车人名字"></td> --%>
            <td>
	        <div class="list_date">
        ...
        <tbody>
          <tr>
            <th>违章时间：</th>
            <td><input type="text" id="peccancyTimes" name="peccancyTimes" class="Wdate nt-text" 
            			onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="<fmt:formatDate value="${requestScope.data.payTime}" pattern="yyyy-MM-dd"/>"></td>
            <th>违章地点：</th>
            <td><input class="nt-text" type="text" id="peccancyAddress" name="peccancyAddress" value="${requestScope.data.peccancyAddress }"></td>
            <th>违章情况：</th>
            <td><input class="nt-text" type="text" id="peccancyInfo" name="peccancyInfo" value="${requestScope.data.peccancyInfo }"></td>
            <th>情况描述：</th>
            <td><input class="nt-text" type="text" id="peccancyDescribe" name="peccancyDescribe" value="${requestScope.data.peccancyDescribe }"></td>
          </tr>
          <tr>
            <th>处罚意见：</th>
            <td colspan="7"><input class="nt-text-long" type="text" id="punish" name="punish" value="${requestScope.data.punish }"></td>
          </tr>
        </tbody>
        <tfoot></tfoot>
        </table>
        ...
        <tbody>
          <tr>
            <th>处罚金额：</th>
            <td><input class="nt-text" type="text" id="fineMoney" name="fineMoney" value="${requestScope.data.fineMoney }"></td>
            <th>个人负担比例：</th>
            <td><input class="nt-text" type="text" id="driverProportion" name="driverProportion" value="${requestScope.data.driverProportion }"></td>
            <th>公司负担比例：</th>
            <td><input class="nt-text" type="text" id="companyProportion" name="companyProportion" value="${requestScope.data.companyProportion }"></td>
            <th>个人负担金额：</th>
